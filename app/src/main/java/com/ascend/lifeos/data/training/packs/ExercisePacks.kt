// GENERATED by tools/exercisedb/codegen.js — DO NOT EDIT. Aggregator über alle Packs.
...
object ExercisePacks {
    ...
    val NEW: List<ExerciseEntity> = ExercisePackCalisthenics.EXERCISES +
            ExercisePackGymVariants.EXERCISES +
            ExercisePackKettlebell.EXERCISES

    val EDGES: List<ExerciseEdgeEntity> = SeedV2Overrides.EDGES +
            ExercisePackCalisthenics.EDGES +
            ExercisePackGymVariants.EDGES +
            ExercisePackKettlebell.EDGES

    const val CATALOG_HASH: String = "v2-2ee3422bf1493b8d"

    fun upgrade(e: ExerciseEntity): ExerciseEntity = SeedV2Overrides.apply(e)
}
